...
<?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'main-img' ); ?>
 <header class="header-img" style="background-image: url(<?php echo $url ?>);">
	<div class="overlay">
		<nav class="main-menu">
			<div class="container"> 
		...
		<div class="container">
			<div class="hero-content">
				<h2 class="my-career-title"><?php bloginfo('description') ?></h2>
				<h1 class="main-title">KEVIN'S <span>PORTFOLIO</span></h1>
			</div>	
		</div>
	</div>
</header>
